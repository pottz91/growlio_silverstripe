<nav x-data="{ isOpen: false }" class="container shadow-md mb-6 py-6 max-w-4xl mx-auto pt-6 lg:flex lg:items-center lg:justify-between">
    <div class="flex items-center justify-between">
    <div>
        <a class="mx-5 text-2xl font-bold text-purple-600 hover:text-gray-700 dark:text-white dark:hover:text-gray-300 lg:text-3xl" href="/">GROWLIO.DE</a>
    </div>
    ...
    <a class="mx-5 mt-4 block h-10 transform rounded-md border px-5 py-2 text-center text-sm capitalize text-gray-700 transition-colors duration-300 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 lg:mt-0 lg:w-auto" href="#">Mehr Hotels entdecken</a>
    </div>
</nav>